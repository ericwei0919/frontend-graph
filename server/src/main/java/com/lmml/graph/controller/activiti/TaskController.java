...
public class TaskController {
    ...
    @PostMapping("{hostObjectId}/assign")
    public ResponseWrapper assignTask(@PathVariable Long hostObjectId, @RequestBody BpmTaskCommand bpmTaskCommand) throws Exception {
        boolean success = taskService.assignTask(hostObjectId, bpmTaskCommand);
        return ResponseWrapper.success(success);
    }

    @PostMapping("{hostObjectId}/complete")
    public ResponseWrapper completeTask(@PathVariable Long hostObjectId, @RequestBody BpmTaskCommand bpmTaskCommand) throws Exception {
        boolean success = taskService.completeTask(hostObjectId, bpmTaskCommand);
        return ResponseWrapper.success(success);
    }
